...
| Sparse vector packing | Fig. 3 explains vector-wise sparsity behavior, not exact bit packing | Define project-local compressed vector and index formats, then prove sparse output equals dense output | Phase 6 assumption |
